...
<body>
	<div class="containerdetail">
	 ...
	 <div id="pagebody">
                        	...
                        	<div style="text-align:left;font-color:#123546;font-size:13px;">当前位置: <a href="index.jsp">首页</a> > 下载中心</div>
<!--                             <div id="table_list"> -->
<!--                             		<h3>新闻动态列表</h3> -->
                            		<table style="text-align:center; line-height:30px; align:center;margin:0px auto;">
                            			...
                            			<tr style="font-size:12px;">
                            				...
                            				<td valign="baseline" style="text-align:left;"><a href="<%=rs_page.getString("name") %>"><%=rs_page.getString("title") %></a></td>                           				
                            		...
                            		<div class="mainbobybottom">
                            		 <a href=download.jsp?page=1>首页</a>&nbsp; 
								   <a href=download.jsp?page=<%=intPage-1 %>>上一页</a>&nbsp;
								   <%
								     for(int j=intPage-11;j<=intPage+12;j++){
								         ...
								         %>
								           <a href=download.jsp?page=<%=j%>><%=j%></a>&nbsp;
								         <%
								         if(j>10)
								         break;
								     }
								   %>
								  <a href=download.jsp?page=<%=intPage+1 %>>下一页</a>&nbsp;
								   <a href=download.jsp?page=<%=intPageCount %>>尾页</a>&nbsp;	
                            		</div>
                            </div>
