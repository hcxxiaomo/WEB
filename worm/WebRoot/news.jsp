...
<%
	...
	String sql = "select * from worm_news order by id desc";
...
<body>
	<div class="containerdetail">
	 ...
	 <div id="pagebody">
                        	...
                        	<div style="text-align:left;font-color:#123546;font-size:13px;">当前位置: <a href="index.jsp">首页</a> > 新闻动态</div>
<!--                             <div id="table_list"> -->
<!--                             		<h3>新闻动态列表</h3> -->
                            		<table style="text-align:center; line-height:30px; align:center;margin:0px auto;">
                            			...
                            			<tr style="font-size:12px;">
                            				...
                            				<td valign="baseline" style="text-align:left;"><a href="detail.jsp?type=1&id=<%=rs_page.getString("id")%>"><%=rs_page.getString("title") %></a></td>                           				
