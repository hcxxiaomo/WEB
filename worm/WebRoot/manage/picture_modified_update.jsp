...
<SCRIPT type="text/javascript">
	alert("只允许上传图片，亲！");
	window.location = 'picture_modified.jsp';
</script>
<%
	}
	try {
...
// 				out.println(name_new);				
				...
				//以下为修改三个内容
 				...
 				String sql_title = "update worm_pictures set title = '"+title_new+"' where id='"+id+"'";
		   	     String sql_name = "update worm_pictures set picurl = '"+name_new+"' where id='"+id+"'";
