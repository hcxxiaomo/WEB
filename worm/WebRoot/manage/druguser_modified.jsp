...
<%
	...
	String sql = "delete from worm_managedrug where id = '" + id + "'";
	//String sql_title = "select * from worm_manage where id = '" + id + "'";
	String sql2 = "select * from worm_managedrug where id = '" + id + "'";
...
<body style="background-color:#eef2fb;">
	...
	<div>
		  <form name="news_modified_update" method="post" action="manage/druguser_modified_update.jsp"> 
		<table>
			<%
				rs.next();
			%>
