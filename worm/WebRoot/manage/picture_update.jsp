...
// 				out.println(dbext);
				...
				String title =dbFileName.toString().substring(0, dbFileName.length()-4);
...
// 				out.println(name);
// 				out.println(time);
					String sql_add = "insert into worm_pictures (title,picurl,time) values('" +title+ "','" +name+ "','" +time+ "')";
