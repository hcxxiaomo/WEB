...
<%
	...
	String sql = "select * from worm_managedrug order by id desc";
...
<body style="background-color:#eef2fb;">
	...
	<div>
		...
		<table style="font-size:14px;">
			...
			<%
				while (rs.next()) {
			%>
			 <form method='post' action='manage/druguser_modified.jsp' >
			<tr>
	...
	<div>
		<form name="news" method="post" action="manage/druguser_update.jsp">
			<table style="font-size:14px;">
				<tr>
					<td>用户:</td>
