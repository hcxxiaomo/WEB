...
<%
	...
	String sql = "select * from worm_others where id = 2";
...
<body style="background-color:#eef2fb;">
	...
	<div>
	<h4 style="color:red;">研究简介内容后台管理</h4>
	
		  <form name="news_modified_update" method="post" action="research_update.jsp"> 
		<table>
			<%
				rs.next() ;
			%>
			<tr>
				<td></td>
				<td><script  id="editor" type="text/plain" style="width:1076px;"><%=rs.getString("content")%></script></td>
			</tr>
			<tr>
				<td></td>
