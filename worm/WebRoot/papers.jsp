...
<%
	...
	String sql = "select * from worm_papers order by id desc";
	...
	<div class="containerdetail">
	 ...
	 <div id="pagebody">
			...
			<div class="lefttitle">科学研究</div>
                        	...
                        	<div style="text-align:left;font-color:#123546;font-size:13px;">当前位置: <a href="index.jsp">首页</a> > 专著论文</div>
                           
                            		<table style="text-align:center; line-height:30px; align:center;margin:0px auto;">
                            			<tr style="height:30px;">
                            				<td style="width:8px;"></td>
                            				<td style="width:740px;text-align:left;"></td>                       
                            				<td ></td>
                            			</tr>
                            			...
                            			<tr style="font-size:12px;">
                            				...
                            				<td valign="baseline" style="text-align:left;"><a href="detail.jsp?type=3&id=<%=rs_page.getString("id")%>"><%=rs_page.getString("title") %></a></td>                           				
                            				<td></td>
                            			</tr>
                            			<% 
                            		...
                            		<div class="mainbobybottom">
                            		 <a href=papers.jsp?page=1>首页</a>&nbsp; 
								   <a href=papers.jsp?page=<%=intPage-1 %>>上一页</a>&nbsp;
								   <%
								     for(int j=intPage-11;j<=intPage+12;j++){
								         ...
								         %>
								           <a href=papers.jsp?page=<%=j%>><%=j%></a>&nbsp;
								         <%
								         if(j>10)
								         break;
								     }
								   %>
								  <a href=papers.jsp?page=<%=intPage+1 %>>下一页</a>&nbsp;
								   <a href=papers.jsp?page=<%=intPageCount %>>尾页</a>&nbsp;	
                            		</div>
                            </div>
