...
<%
	...
	String sql = "select * from worm_notices order by id desc";
...
<body>
	<div class="containerdetail">
	 ...
	 <div id="pagebody">
                        	...
                        	<div style="text-align:left;font-color:#123546;font-size:13px;">当前位置: <a href="index.jsp">首页</a> > 通知公告</div>
<!--                             <div id="table_list"> -->
<!--                             		<h3>新闻动态列表</h3> -->
                            		<table style="text-align:center; line-height:30px; align:center;margin:0px auto;">
                            			...
                            			<tr style="font-size:12px;">
                            				...
                            				<td valign="baseline" style="text-align:left;"><a href="detail.jsp?type=2&id=<%=rs_page.getString("id")%>"><%=rs_page.getString("title") %></a></td>                           				
                            		...
                            		<div class="mainbobybottom">
                            		 <a href=notices.jsp?page=1>首页</a>&nbsp; 
								   <a href=notices.jsp?page=<%=intPage-1 %>>上一页</a>&nbsp;
								   <%
								     for(int j=intPage-11;j<=intPage+12;j++){
								         ...
								         %>
								           <a href=notices.jsp?page=<%=j%>><%=j%></a>&nbsp;
								         <%
								         if(j>10)
								         break;
								     }
								   %>
								  <a href=notices.jsp?page=<%=intPage+1 %>>下一页</a>&nbsp;
								   <a href=notices.jsp?page=<%=intPageCount %>>尾页</a>&nbsp;	
                            		</div>
                            </div>
