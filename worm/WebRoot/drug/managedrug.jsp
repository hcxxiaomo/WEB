...
<div id="xpf_med_add" style="display:none">
    		...
    		<form method="post" action="AddMed">
    			<table>
    				...
    				<tr>
    					<td>药品购入数量:</td>
    					<td><input name="xpf_med_buymount" />请输入数字</td>
    				</tr>
    				<tr>
    					<td>药品剩余数量:</td>
    					<td><input name="xpf_med_nowmount" />请输入数字</td>
    				</tr>
    				<tr>
    					<td>药品计量单位:</td>
    	...
    	<div id="xpf_dev_add" style="display:none">
    		...
    		<form method="post" action="AddDev">
    			<table>
    				...
    				<tr>
    					<td>器械购入数量:</td>
    					<td><input name="xpf_dev_buymount" />请输入数字</td>
    				</tr>
    				<tr>
    					<td>器械现有数量:</td>
    					<td><input name="xpf_dev_nowmount" />请输入数字</td>
    				</tr>
    				<tr>
    					<td>器械借出数量:</td>
    					<td><input name="xpf_dev_lendmount" />请输入数字</td>
    				</tr>
    				<tr>
    					<td>器械在库数量:</td>
    					<td><input name="xpf_dev_inmount" />请输入数字</td>
    				</tr>
    				<tr>
    					<td>器械计量单位:</td>
    	...
    	<div id="xpf_book_add" style="display:none">
    		...
    		<form method="post" action="AddBook">
    			<table>
    				...
    				<tr>
    					<td>书本购入数量:</td>
    					<td><input name="xpf_book_buymount" />请输入数字</td>
    				</tr>
    				<tr>
    					<td>书本现有总数量:</td>
    					<td><input name="xpf_book_nowmount" />请输入数字</td>
    				</tr>
    				<tr>
    					<td>书本借出数量:</td>
    					<td><input name="xpf_book_lendmount" />请输入数字</td>
    				</tr>
    				<tr>
    					<td>书本在库数量:</td>
    					<td><input name="xpf_book_inmount" />请输入数字</td>
    				</tr>
    				<tr>
    					<td>书本存放位置:</td>
