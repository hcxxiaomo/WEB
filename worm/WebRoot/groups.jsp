...
<%
	...
	String sql = "select * from worm_groups order by id desc";
	...
	<div class="containerdetail">
	 ...
	 <div id="pagebody">
						...
						<div class="lefttitle">创新文化</div>
                        	...
                        	<div style="text-align:left;font-color:#123546;font-size:13px;">当前位置: <a href="index.jsp">首页</a> > 团队文化</div>
                            		...
                            		<table style="text-align:center; line-height:30px; align:center;margin:0px auto;">
                            			...
                            			<tr style="font-size:12px;">
                            				...
                            				<td valign="baseline" style="text-align:left;"><a href="detail.jsp?type=7&id=<%=rs_page.getString("id")%>"><%=rs_page.getString("title") %></a></td>                           				
                            		...
                            		<div class="mainbobybottom">
                            		 <a href=gruops.jsp?page=1>首页</a>&nbsp; 
								   <a href=gruops.jsp?page=<%=intPage-1 %>>上一页</a>&nbsp;
								   <%
								     for(int j=intPage-11;j<=intPage+12;j++){
								         ...
								         %>
								           <a href=gruops.jsp?page=<%=j%>><%=j%></a>&nbsp;
								         <%
								         if(j>10)
								         break;
								     }
								   %>
								  <a href=gruops.jsp?page=<%=intPage+1 %>>下一页</a>&nbsp;
								   <a href=gruops.jsp?page=<%=intPageCount %>>尾页</a>&nbsp;	
                            		</div>
                            </div>
