    ...
    <div id="containerinside">
		<div id="pagebody">
				<div class="detailsbodyleft">
					...
					<div class="leftword"><a href="titles.jsp?type=3">含弘讲堂</a><br/></div>
					<div class="leftword"><a href="titles.jsp?type=4">就业信息</a><br/></div>
					<div class="leftword"><a href="titles.jsp?type=5">社会实践</a><br/></div>
