	     ...
	     id = new String(id.getBytes("utf-8"),"utf-8");	 	
			...
			if (file_size != 0){
				...
				dbsaveurl = "/yjshnew/"+url+filename + "." +dbext;//数据库中路径	
  				...
  				String sql_picurl = "update yjsh_pictures set picurl = '"+dbsaveurl+"' where id='"+id+"'";
	   	    	 yjsh.executeUpdate(sql_picurl);

				}
   	     }
   	     String sql_title = "update  yjsh_pictures set title = '"+title+"' where id='"+id+"'";
